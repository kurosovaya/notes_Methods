...
#mongo_client.drop_database('notes_db')
notes_db = mongo_client['notes_db']

#work_collection = notes_db['work_notes']
#private_collection = notes_db['private_notes']
#archived_collection = notes_db['archived_notes']
